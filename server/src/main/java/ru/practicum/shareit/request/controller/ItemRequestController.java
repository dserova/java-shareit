...
public class ItemRequestController {
    ...
    @GetMapping("/all")
    public List<ItemRequestResponseWithItemsDto> getItemRequestById(@RequestHeader(userIdParameterName) long userId,
    ...
    @GetMapping("/{id}")
    public ItemRequestResponseWithItemsDto getItemRequestById(@PathVariable(name = "id") long id,
                                                              @RequestHeader(userIdParameterName) long userId) {
        return itemRequestService.getItemRequestById(id, userId);
    }

    @PostMapping
    public ItemRequestResponseDto createItemRequest(@RequestHeader(userIdParameterName) long userId,
