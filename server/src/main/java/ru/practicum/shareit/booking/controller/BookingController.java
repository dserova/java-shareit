...
public class BookingController {
    ...
    @GetMapping("/{id}")
    public BookingResponseDto getBookingById(@RequestHeader(userIdParameterName) long userId,
    ...
    @PostMapping
    public BookingResponseDto createBooking(@RequestHeader(userIdParameterName) long userId,
    ...
    @GetMapping
    public List<BookingResponseDto> getAllBooking(@RequestParam(name = "from", defaultValue = "0") int from,
                                                  @RequestParam(name = "size", defaultValue = "10") int size,
                                                  @RequestHeader(userIdParameterName) long userId,
                                                  @RequestParam(name = "state", defaultValue = "ALL") Filter state) {
    ...
    @GetMapping("/owner")
    public List<BookingResponseDto> getAllBookingByOwner(@RequestParam(name = "from", defaultValue = "0") int from,
                                                         @RequestParam(name = "size", defaultValue = "10") int size,
                                                         @RequestHeader(userIdParameterName) long userId,
                                                         @RequestParam(name = "state", defaultValue = "ALL") Filter state) {
    ...
    @PatchMapping("/{id}")
    public BookingResponseDto updateBooking(@RequestHeader(userIdParameterName) long userId,
    ...
    @DeleteMapping("/{id}")
    void deleteBooking(@RequestHeader(userIdParameterName) long userId,
                       @PathVariable(name = "id") long bookingId) {
