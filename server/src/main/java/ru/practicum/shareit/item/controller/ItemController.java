...
public class ItemController {
    ...
    @GetMapping
    public List<ItemResponseDto> getAllItems(@RequestParam(name = "from", defaultValue = "0") int from,
    ...
    @GetMapping("/{id}")
    public ItemResponseDto getItemById(@RequestHeader(userIdParameterName) long userId,
    ...
    @PostMapping
    public ItemRequestDto createItem(@RequestHeader(userIdParameterName) long userId,
    ...
    @PatchMapping("/{id}")
    public ItemRequestDto updateItem(@RequestHeader(userIdParameterName) long userId,
                                     @PathVariable(name = "id") long itemId,
                                     @RequestBody ItemRequestDto itemRequestDto) {
    ...
    @DeleteMapping("/{id}")
    void deleteItem(@RequestHeader(userIdParameterName) long userId,
                    @PathVariable(name = "id") Long itemId) {
        itemService.deleteItem(userId, itemId);
    }

    @GetMapping("/search")
    public List<ItemRequestDto> search(@RequestParam(name = "from", defaultValue = "0") int from,
                                       @RequestParam(name = "size", defaultValue = "10") int size,
                                       @RequestHeader(userIdParameterName) long userId,
                                       @RequestParam(name = "text", defaultValue = "") String partOfName) {
    ...
    public CommentResponseDto createComment(@RequestHeader(userIdParameterName) long userId,
                                            @PathVariable(name = "id") long itemId,
